...
-(NSArray *)groups
{
    ...
    if (!_groups) {
        ...
        //第一组
        //存储控制器class
        SettingItem *item11 = [SettingItemArrow itemWithTitle:@"软件设置" ];
        SettingItem *item12 = [SettingItemArrow itemWithTitle:@"精益产品" ];
        ...
        SettingItem *item33 = [SettingItemArrow itemWithTitle:@"关于" ];
